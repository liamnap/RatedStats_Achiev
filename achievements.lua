...
local PvpRankColumns = {
    ...
    { key = "j",  label = "Strategist (2400)",     prefix = "Strategist:",    icon = "Interface\\PVPFrame\\Icons\\UI_RankedPvP_07_Small.blp", tint = { 0.65, 1.00, 0.65 } }, -- brighter green
    { key = "k",  label = "Glad (2400)",           prefix = "Gladiator:",     icon = "Interface\\PVPFrame\\Icons\\UI_RankedPvP_07_Small.blp", tint = { 1.00, 0.55, 0.92 } }, -- brighter pink
    { key = "l",  label = "Legend (2400)",         prefix = "Legend:",        icon = "Interface\\PVPFrame\\Icons\\UI_RankedPvP_07_Small.blp", tint = { 1.00, 0.55, 0.55 } }, -- brighter red
